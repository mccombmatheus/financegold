...
const ICONES_SEGMENTO = {
  joalheria: '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M2 18h14l-3-7H5z"/><path d="M5 11l3-3h9l-4 3M17 8l4 7-5 3"/></svg>',
